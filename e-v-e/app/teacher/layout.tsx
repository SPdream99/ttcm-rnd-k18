...
export default function TeacherLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 text-zinc-900 font-sans flex-col md:flex-row">
      ...
      <header className="md:hidden bg-white border-b-2 border-zinc-200 px-4 py-3 sticky top-0 z-50 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-2.5">
          <button
            ...
            aria-label="Toggle Teacher Navigation Menu"
          >
          ...
          <Link href="/teacher/dashboard" className="flex items-center gap-2">
            ...
            />
            <span className="text-[9px] px-1.5 py-0.5 rounded font-bold bg-red-100 text-red-700">GIÁO VIÊN</span>
          </Link>
        </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-zinc-100">
                <div className="flex items-center gap-2.5">
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-xs text-red-600 uppercase tracking-wider">Giáo Viên</h3>
      ...
      {/* ── Desktop Teacher Sidebar (Visible on screens >= md) ── */}
      <aside className="hidden md:flex w-64 h-screen bg-white border-r-2 border-zinc-200 p-5 flex-col justify-between z-40 sticky top-0 shrink-0 overflow-y-auto shadow-sm">
        <div className="space-y-6">
          {/* Brand Header */}
          <Link href="/teacher/dashboard" className="block px-1">
            <img
              src="/logo.png"
              alt="E-V-E"
          ...
          <div className="p-3 rounded-xl bg-zinc-50 border border-zinc-200 flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[10px] text-zinc-500 uppercase font-medium">Giáo Viên</div>
            </div>
          </div>
      ...
      {/* ── Floating AI Teacher Assistant Mini Widget ── */}
